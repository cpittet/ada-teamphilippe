...
After the Americans, come the Europeans with around 20% of the quotes. An interesting thing is, despite being the continent with the largest population, Asia comes only in the third place with respect to the proportion of quotes made. It is even worse for Africa which is the second continent in terms of population but that comes in last position on the proportion of the quotes ladder. The "Other" category corresponds to Antartica and other similar islands. As they represent almost no data point, we can safely remove them from our subsequent analysis. We can see that much our data set is biased towards European and American. 
