...
<iframe frameborder="no" border="0" marginwidth="0" onload="setDisplayNone('1')" id="cluster1" marginheight="0" width="100%" height="650" allowfullscreen="true" src="figures/cluster_distribution_1.html"></iframe>
<iframe frameborder="no" border="0" marginwidth="0" onload="setDisplayNone('2')" id="cluster2" marginheight="0" width="100%" height="650" allowfullscreen="true" src="figures/cluster_distribution_2.html"></iframe>
<iframe frameborder="no" border="0" marginwidth="0" onload="setDisplayNone('3')" id="cluster3" marginheight="0" width="100%" height="650" allowfullscreen="true" src="figures/cluster_distribution_3.html"></iframe>
<iframe frameborder="no" border="0" marginwidth="0" onload="setDisplayNone('4')" id="cluster4" marginheight="0" width="100%" height="650" allowfullscreen="true" src="figures/cluster_distribution_4.html"></iframe>
<iframe frameborder="no" border="0" marginwidth="0" onload="setDisplayNone('5')" id="cluster5" marginheight="0" width="100%" height="650" allowfullscreen="true" src="figures/cluster_distribution_5.html"></iframe>
